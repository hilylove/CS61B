...
public class Tileset {
    ...
    public static final TETile WALL = new TETile('#', new Color(216, 128, 128),
            Color.darkGray, "wall");
    public static final TETile FLOOR = new TETile('·', new Color(128, 192, 128),
            Color.black, "floor");
    ...
    public static final TETile ROOMFLOOR = new TETile('屋', new Color(128, 192, 128),
            Color.orange, "developed floor");
}
